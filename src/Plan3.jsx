...
const PlanSection = () => {
  ...
  return (
    <section className="relative md:py-8 w-full mx-auto h-screen md:h-auto">
      ...
      ></div>
      {/* For larger screens */}
      <div className="text-center py-8 md:my-0 relative hidden xs:block">
      ...
      <div className="xs:hidden h-screen w-full flex flex-col justify-center items-center gap-y-2">
        ...
        <ul className="text-gray-700 dark:text-gray-300 mb-8 shadow-lg bg-white p-8 rounded-lg m-2 h-72">
